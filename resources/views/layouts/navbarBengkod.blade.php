    ...
    <a href="{{ url('/') }}" class="text-xl font-medium max-md:mb-1">Bengkel Koding</a>
        ...
        <div>
            @auth
                ...
                @endphp
                <a href="{{ url($url) }}" class="ml-5 text-xl hover:border-b-2 pb-1 px-3 transition ease-in-out duration-150 active:bg-transparent focus:bg-transparent ">Dashboard</a>
            @else
