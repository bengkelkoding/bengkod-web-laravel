...
<x-universal-layout>
    <div class="container mx-auto">
        ...
        <div class="">
            {{-- 1 --}}
            <div class="headline1 flex flex-col lg:flex-row my-5 md:my-10 lg:mx-20  justify-between max-lg:items-center items-center">
                ...
                <div class="relative mt-5 md:mt-10 lg:mt-0">
                    <div class="relative w-[80vw] h-[80vw] md:w-[60vw] md:h-[60vw] lg:w-[30vw] lg:h-[30vw] rounded-xl overflow-hidden">
                        <div class="w-full slide">
                            <img src="assets\img\dokumentasi-1.png" class="w-full" loading="lazy" alt="Gambar Mengajar" />
                        </div>
                        <div class="w-full slide">
                            <img src="assets\img\dokumentasi-2.png" class="w-full" loading="lazy" alt="Gambar Mengajar" />
                        </div>
                        <div class="w-full slide">
                            <img src="assets\img\dokumentasi-3.png" class="w-full" loading="lazy" alt="Gambar Mengajar" />
                        </div>
                        <div class="w-full slide">
                            <img src="assets\img\dokumentasi-4.png" class="w-full" loading="lazy" alt="Gambar Mengajar" />
                        </div>
                    </div>
                    <div class="absolute shadow-[0_4px_20px_0_rgba(0,0,0,0.25)] bottom-[15px] md:bottom-[30px] left-[-20px] md:left-[-105px] flex flex-col justify-center items-center bg-white px-4 py-2 md:px-7 md:py-5 rounded-md">
                        ...
                        <div class="flex gap-1">
                            @foreach ($gambar as $index => $item)
                                <div class="rounded-full aspect-square ml-[-10px] md:ml-[-16px] w-6 h-6 md:w-10 md:h-10 overflow-hidden">
                ...
                <div class="flex justify-center flex-wrap gap-4 lg:justify-around ">
                    ...
                    <div class="boxExplain3 w-80 2xl:w-96 p-4 flex items-center gap-4 justify-center rounded-md shadow-xl hover:shadow-none border transition ease-in-out duration-250">
                        ...
                        <div class="whyUs_detail">
                            ...
                            <p class="text-sm">Kami memberikan dukungan pribadi untuk membantu kamu mencapai tujuan belajarmu.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="h-auto mx-auto bg-primary-color rounded-2xl flex flex-col my-28 md:w-[80%] text-white p-10">
            ...
            <div class="containerCard flex flex-col lg:flex-row mt-6 lg:mt-0 justify-center md:gap-5 lg:pl-10 lg:gap-20 md:p-5">
                {{-- box1 --}}
                ...
                <div class="relative w-full h-max overflow-hidden rounded-lg">
                    <div class="hidden slide2 bg-contain">
                        <img src="assets\img\h61.jpg" class="h-40 md:h-60 lg:h-72 object-cover overflow-hidden" alt="Lobby H6 1">
                    </div>
                    <div class="hidden slide2 bg-contain bg-center">
                        <img src="assets\img\h62.jpg" class="h-40 md:h-60 lg:h-72 object-cover overflow-hidden" alt="Lobby H6 2">
                    </div>
                    <div class="hidden slide2 bg-contain ">
                        <img src="assets\img\h63.jpg" class="h-40 md:h-60 lg:h-72 object-cover overflow-hidden" alt="Lobby H6 3">
                    </div>
                </div>
                {{-- box2 --}}
                <div class="boxAbout2">
                    <h1 class="hidden lg:block mx-auto text-xl font-bold md:text-3xl">Mengenal Bengkel Koding</h1>
                    <p class="lg:text-justify my-6 text-base md:text-lg">Bengkel Koding merupakan program yang diselenggarakan oleh Program Studi Teknik Informatika Universitas Dian Nuswantoro untuk membantu mahasiswa memahami pembelajaran dibidang ilmu teknologi.</p>
                    {{-- dataCard --}}
                    <div class="dataCard flex  items-center text-black my-3 gap-4">
                        <div class="dataCard1 gap-2 bg-green-300 w-44 h-16 xl:w-48 xl:h-20 2xl:w-60 2xl:h-28 rounded flex items-center justify-center">
                            <p class="text-4xl md:text-6xl  font-bold">5</p>
                            <p class="font-bold text-base md:text-xl">TOP <br><span class="font-normal">Course</span></p>
                        </div>
                        <div class="dataCard1  bg-yellow-300 w-44 h-16 xl:w-48 xl:h-20 2xl:w-60 2xl:h-28 rounded flex flex-col items-center justify-center">
