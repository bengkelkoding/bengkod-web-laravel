        ...
        <div class="max-w-[70%] flex my-[5em] items-center overflow-x-scroll snap-mandatory snap-x">
            @foreach ($kursuses as $kursus)
                <a href="/kursus/{{ $kursus->id }}" class="snap-center">
                    <div
                        class="m-[8px] border-2 rounded-md hover:drop-shadow-md bg-white min-w-[250px] flex flex-col justify-center transition ease-in-out duration-150">
                        <div class="m-4 py-1">
                            ...
                            <p class="font-medium leading-1 text-gray-500 text-[14px]">
                                <img src="assets\admin\icons\calendar-days-solid.png" alt=""
                                    class="inline mr-2">
                                {{ $kursus->hari }}
                            </p>
                            <p class="font-medium leading-1 text-gray-500 text-[14px]">
