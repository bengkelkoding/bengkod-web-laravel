<x-admin>
    ...
    <div class="py-5 ">
        ...
        <div
            class="max-w-screen-md mx-auto sm:px-6 px-3 lg:px-8 w-full lg:w-[500px] h-[400px] rounded border-2 border-indigo-500/100 mt-3">
            <h1 class="font-bold text-[28px] text-center py-3">Upload CSV</h1>

            <div class="h-[30vh] flex flex-col items-center justify-center bg-gray-400/30 drop-shadow-lg rounded-md cursor-pointer"
            ...
            <form action="/import" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-center items-center mt-9">
                    <button type="submit"
                        class="bg-[#114D91] rounded-md w-[116px] text-xl h-auto hover:bg-cyan-500"><span
                            class="text-[14px] text-white">Import CSV</span></button>
                </div>
            </form>
        </div>
