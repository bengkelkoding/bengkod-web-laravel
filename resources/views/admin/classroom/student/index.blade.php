<x-admin>
    ...
    <div class="container-fluid">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <p class="fw-semibold mb-4"><span class="card-title mr-4">Mahasiswa
                            {{ $classroom->name . ' ' . $classroom->day . ' ' . $classroom->time }}</span></p>
                    <div class="row">
                        <div class="col">
                            <form>
                                <div class="flex">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                ...
                                                <a
                                                    href="{{ url('admin/classroom/' . $classroom->id . '/student/' . $student->id . '/log') }}"><i
                                                        class="ti ti-pencil"></i> Log</a>
                                            </span>
                                        </td>
                                    </tr>
                                @empty
