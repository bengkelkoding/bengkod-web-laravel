<x-admin>
    ...
    <div class="container-fluid">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <p class="fw-semibold mb-4"><span class="card-title mr-4">Tabel Dosen</span><a
                            href="{{ route('admin.lecture.create') }}" class="btn btn-outline-dark rounded-pill"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex">
                                                ...
                                                <form method="POST"
                                                    action="{{ route('admin.lecture.destroy', $lecture->id) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <span
