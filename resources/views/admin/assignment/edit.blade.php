        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.assignment.update', $assignment->id) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <!-- Judul -->
                        <div class="mb-3">
                            ...
                            <x-text-input id="judul" class="block mt-1 w-full" type="text" name="judul"
                                :value="old('judul') ?? $assignment->judul" required autofocus autocomplete="judul" />
                        ...
                        <div class="mb-3">
                            ...
                            <div class="relative mb-3 mt-3" data-te-date-timepicker-init data-te-input-wrapper-init data-te-disable-past="true">
                                <input type="text"
                                    ...
                                    id="waktu_mulai" name="waktu_mulai" value="{{ old('waktu_mulai') ?? $waktu_mulai }}"/>
                                <label for="form1"
