<x-app-layout>
    ...
    <div class="box-border flex flex-col justify-center p-8 m-5 ">
        <a href="{{ url('mahasiswa') }}" class="text-xl font-medium px-2 transition ease-in-out duration-150 text-gray-500 hover:text-gray-700">< Kembali</a>
            ...
            <p class="text-justify md-pl-0 mb-2">{{ $assignment->deskripsi }}</p>
                <table class="">
                    ...
                    <tr>
                        ...
                        <td class="pr-3">:</td>
                        <td class="min-w-auto"><a href="{{ url('storage/soal/' . $assignment->file_soal) }}">{{ $assignment->file_soal }}</a></td>
                    </tr>
                    @endif
                    <tr>
